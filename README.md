...
* **Rich Modalities:** 
    * 📝 **Writing Mode:** Clean, block-based text editor with rich formatting (bold, strikethrough, highlight).
...
* **Highly Customizable:**
    * Automatic Dark/Light mode detection with a custom theme color picker.
